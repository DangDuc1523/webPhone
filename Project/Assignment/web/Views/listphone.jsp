...
<html>
    <head>
        ...
        <style>
            ...
            .list {
                ...
                justify-content: start; /* Căn các phần tử theo hai bên của container */
                margin: 0px 10%;
            }
    ...
    <body>
        ...
        <!-- Kiểm tra account trong session có tồn tại hay không -->
        <div class="task1">
        ...
        <div class="manu">
            <button type="submit" value="apple" name="manu" style="border: none"><img src="img/apple.png" alt="alt" style="height: 50px; width: 70px"/></button>
            <button type="submit" value="samsung" name="manu" style="border: none"><img src="img/samsung.png" alt="alt" style="height: 50px; width: 100px"/></button>
            <button type="submit" value="oppo" name="manu" style="border: none"><img src="img/opp.png" alt="alt" style="height: 50px; width: 140px"/></button>
            <button type="submit" value="google" name="manu" style="border: none"><img src="img/gpixel.jpg" alt="alt" style="height: 50px; width: 100px"/></button>
            <button type="submit" value="nokia" name="manu" style="border: none"><img src="img/nokia1.png" alt="alt" style="height: 50px; width: 100px"/></button>
            <button type="submit" value="oneplus" name="manu" style="border: none"><img src="img/oneplus1.png" alt="alt" style="height: 50px; width: 100px"/></button>
                
        </div>
        </form>
 </div>
        <!-- lis: kiểu trả về Phone , lấy giá trị từ database thông qua ListServlet -->
        <h2> List Of Phone </h2>
        <div class="list">
            <c:forEach var ="lis" items="${list}">
                <div class="phone">
                    <img src="${lis.imgProd}" alt="${lis.model}">
                    <h3>${lis.model}</h3>
                    <p>${lis.price}$</p>
