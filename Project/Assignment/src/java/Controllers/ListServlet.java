...
public class ListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //Gọi phương thức getPhone trong lớp DAO
        ArrayList<Phone> phone = dao.getPhone();
        Account account = (Account) session.getAttribute("account");
        
        //Đặt biến
        session.setAttribute("account", account);
        request.setAttribute("list", phone);
        request.getRequestDispatcher("Views/listphone.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO c = DAO.INSTANCE;
        ArrayList<Phone> listmanu = c.getSearch(manu);
        request.setAttribute( "list",listmanu);
        request.getRequestDispatcher("Views/listphone.jsp").forward(request, response);
    }
