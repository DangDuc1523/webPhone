...
public class DeleteAdminServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        // idphone: nhận giá trị của "id" được gửi từ Views/productadmin.jsp
        int idphone = Integer.parseInt(request.getParameter("id"));
        
        //Khai báo một biến c kiểu DAO , và gán mẫu Singleton
        DAO c = DAO. INSTANCE;
        ArrayList<Order> order = c.getOrder(idphone);
        if(order != null){
        //Gọi phương thức DeletePhone trong lớp DAO
        c.DeletePhone1(idphone);
    }else{
         c.DeletePhone2(idphone);
        }
